<%-- 
    Document   : Login
    Created on : 07-May-2026, 1:14:26 pm
    Author     : huzaif
--%>
...
<head>
    ...
    <title>WLogin</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/CSS/WLogin.css">
    ...
    <div class="outer">
        ...
        <div class="content">
            ...
            <div class="container">
                ...
                <div class="form">
                    <form action="wloginmodel" method="post">
