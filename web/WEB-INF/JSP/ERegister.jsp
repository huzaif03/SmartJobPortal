<%-- 
    Document   : ERegister.jsp
    Created on : 05-May-2026, 1:12:31 pm
    Author     : huzaif
--%>
...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/CSS/ERegister.css">
</head>
...
<body>
    ...
    <div class="register-wrapper">
        <div class="register-card">
            ...
            <h2 class="register-title">Create Employer Account</h2>
            <p class="register-subtitle">Register to start posting jobs and hiring workers on Smart Job Portal</p>
            ...
            <form action="/SmartJobPortal/FrontController/eregistermodel" method="post" enctype="multipart/form-data" id="register-form">
                ...
                <fieldset class="address-fieldset">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="street" id="street" placeholder="123 Main St" required>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="tel" name="zip_code" id="zip_code" required maxlength="6" placeholder="6-digit code">
                        </div>
                        <div class="form-group">
            ...
            <p class="register-login-link">
                Already have an account? <a href="ELogin">Login</a>
            </p>
